    ...
    */
    public void remove() throws EmptyQueueException
    {
        ...
        else
        {
            ...
            // Remove the front node by pointing 'first' to the next node
            first = first.getNext();
        }
    ...
    */
    public void add(Object o)
    {
        ...
        else
        {
            ...
            // Loop through the list until reaching the last node
            while (c.getNext() != null)
            {
                c = c.getNext();
            }

            // Link the new node to the end of the last node
            c.setNext(n);
        }
